...
Elm.Leaflet.make = function (_elm) {
   "use strict";
   _elm.Leaflet = _elm.Leaflet || {};
   if (_elm.Leaflet.values) return _elm.Leaflet.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Leaflet = Elm.Native.Leaflet.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var create = $Native$Leaflet.create;
   return _elm.Leaflet.values = {_op: _op,create: create};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Leaflet = Elm.Leaflet.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Graphics$Element.show($Leaflet.create(5));
